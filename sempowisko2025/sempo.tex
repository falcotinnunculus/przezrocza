...
\date[dzisiaj]{Interdisciplinary Math-Science Student Konference \\ \SeMPowisko{} 2025\\today}
...
\begin{tikzpicture}[auto, node distance=2cm and 2cm, thick, >=latex, align=center]
  ...
  \node[draw, rectangle, rounded corners, fill=white] (ui) at ($(pi.south)+(-9,-0)$) {User Web UI};
...
\only<3>{\begin{figure}
 ...
 \only<2>{\begin{figure}
 \centering
 \includegraphics[width=0.7\textwidth]{images/2025-05-23-13-21-47.png}
 \caption{insides of antenna}
 \end{figure}}
...
\begin{frame}{decoding signal II}{}
\begin{figure}
 \centering
 \includegraphics[width=0.3\textwidth, angle=270]{images/2025-05-23-13-25-51.png}
 \caption{satellite: CIRBE, transmitter: GFSK}
 \end{figure}
 \vspace{-0.5cm}
\begin{figure}
 \centering
 \includegraphics[width=0.6\textwidth]{images/2025-05-23-13-26-44.png}
%  \caption{}
 \end{figure}
\end{frame}
