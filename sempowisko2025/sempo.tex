...
\title{Talking with the Satellites}
\subtitle{Building a Low-Cost Ground Station with SatNOGS}
\author[M. Winiarski]{Mateusz ,,\(\blacksquare\)'' Winiarski}
\institute[KMPS UJ]{KMPS UJ \\biophysics, FAIS, Jagiellonian University in Kraków} 
...
\begin{frame}{satellite rise}
  \begin{figure}
 \centering
 \includegraphics[width=0.8\textwidth]{images/2025-05-22-16-07-57.png}
 \caption{ number of active satellites by year}
 \end{figure}
\end{frame}
...
\pause
  % Annotation bubble
  \node[align=left, text width=6cm, anchor=west] at (3,-1.5) {
    \textbf{motivation:}\\
    \begin{itemize}[<+->]
...
\begin{tikzpicture}[auto, node distance=2cm and 2cm, thick, >=latex, align=center]
  ...
  \node[draw, rectangle, fill=purple!10] (server) at ($(network.east)-(3.5,0)$) {SatNOGS Server};
  \node[draw, rectangle, rounded corners, fill=red!10] (analysis) at ($(server.south)+(0,-2)$) {Data Processing};
  \node[draw, rectangle, rounded corners, fill=white] (ui) at ($(pi.south)+(-2,-2)$) {User Web UI};
...
\only<2>{\begin{figure}
 ...
 \caption{the antenna with RTL-SDR dongle just outside the Garage's window}
 \end{figure}}
...
\begin{frame}{sdr + computer}{}
  ...
  \begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-05-23-01-09-08.png}
 \caption{rtl-sdr dongle}
 \end{figure}
\column{0.5\textwidth}
\begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-05-23-01-10-57.png}
...
\begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth, angle=90]{images/2025-05-22-21-10-28.png}
 \caption{bad result -- no signal}
 \end{figure}
\column{0.5\textwidth}
\begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth, angle=90]{images/2025-05-22-21-03-20.png}
...
\begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-05-13-15-25-41.png}
%  \caption{}
 \end{figure}
...
\node at (-1.4,1.8) {thx for attention};
  ...
  {\tiny \url{https://github.com/falcotinnunculus/przezrocza/blob/wladca/sempowisko2025/sempo.pdf}}
