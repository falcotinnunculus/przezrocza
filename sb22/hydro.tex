...
\begin{frame}
  \begin{figure}
 \centering
 \includegraphics[width=0.6\textwidth]{images/2025-06-03-22-57-41.png}
 \caption{???????}
 \end{figure}
\end{frame}
...
\section{Termodynamika efektu hydrofobowego}
...
\begin{frame}{Model Franka-Evansa}
  ...
  \begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-06-04-01-30-34.png}
 \caption{Struktura cząsteczek wody dookoła fulerenu w modelu Franka-Evansa (za: \cite{Grabowska_Kuffel_Zielkiewicz_2021})}
 \end{figure}
 
 \begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-06-04-01-46-48.png}
 \caption{Ilustracja modelu w różnych temperaturach (za: \cite{Southall_Dill_Haymet_2002})}
 \end{figure}
...
\begin{frame}{Micele: termodynamika}
  \begin{figure}
 \centering
 \includegraphics[width=0.75\textwidth]{images/2025-06-04-02-08-15.png}
 \caption{}
 \end{figure}
\end{frame}
...
\begin{columns}
  ...
  \begin{figure}
 \centering
 \includegraphics[width=0.5\textwidth]{images/2025-06-04-02-56-14.png}
%  \caption{}
 \end{figure}
\end{columns}
\end{frame}
