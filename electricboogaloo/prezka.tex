...
\institute[m. winiarski, fais uj]{fizyka\(^\dagger\), FAIS, Uniwersytet Jagielloński} 
...
\begin{frame}{positronium states}{and a quick repeat from atomic physics}
  ...
  \begin{itemize}
    \item para-positronium $1^1S_0$
    \item ortho-positronium $1^3S_1$
    \item meta-stable-positronium $2^3S_1$
  \end{itemize}
\vspace{1cm}
  what does this mean?
