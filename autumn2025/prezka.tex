...
\begin{frame}{Układ pomiarowy}
    \begin{figure}
 \centering
 \includegraphics[width=0.49\textwidth]{images/2025-11-13-14-22-09.png}\includegraphics[width=0.49\textwidth]{images/2025-11-13-14-23-37.png}
...
\begin{frame}{Niebieskie punkty w kwadracie}
  \begin{figure}
 \centering

 \includegraphics[width=0.3\textwidth]{images/2025-11-14-15-23-15.png}
 \includegraphics[width=0.69\textwidth]{images/2025-11-14-15-10-20.png}
 \caption{Zależność odległości bocznej przy wejściu \(\Delta y_i\) i odległości bocznej po wyminięciu \(\Delta y_s\), porównanie pomiarów (a) i symulacji (b). Diagonala odpowiada sytuacji, w której piesi nie zareagowali na siebie}
 \end{figure}
\end{frame}

\begin{frame}{Niebieskie punkty w kwadracie (mamy Lenarta w domu)}
  \begin{figure}
 \centering

 \includegraphics[width=0.3\textwidth]{images/2025-11-14-15-23-15.png}
 \includegraphics[width=0.69\textwidth]{images/2025-11-14-15-30-59.png}
 \caption{Zależność odległości bocznej po wyminięciu \(\Delta y_i\) i odległości bocznej przy wyjściu \(\Delta y_s\), porównanie pomiarów (a) i symulacji (b). Diagonala odpowiada sytuacji, w której piesi nie odreagowali na siebie}
 \end{figure}
\end{frame}

\begin{frame}{Zawsze się trochę fituje}
  \begin{figure}
 \centering
 \includegraphics[width=0.99\textwidth]{images/2025-11-14-01-38-01.png}
 \caption[foo]{ab) Rozkład prawdopodobieństwa prędkości \(s=\sqrt{u^2+v^2}\) przed (a) i po (b) wyminięciu, w porównaniu danych do symulacji.\\
 c) CDF minimalnej odległości między pieszymi w trakcie wymijania}
 \end{figure}
\end{frame}
