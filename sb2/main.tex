...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{2025-03-05-02-13-28.png}
\caption{{\footnotesize Obrazowanie w trybie M w tamponadzie serca ukazujące zapadanie się wolnej ściany prawej komory (przemieszczanie się w kierunku przegrody międzykomorowej [strzałka]) podczas gdy zastawka mitralna jest otwarta [groty strzałki].}}
\end{figure}
...
\begin{frame}{USG dopplerowskie}{}
    ...
    \includegraphics[width=0.7\textwidth]{2025-03-05-00-53-18.png}
...
\end{figure}
\nocite{LectureA,Blicharska_Hrynkiewicz_Rokita_2000,Hecht_2017}
